    ...
    <header id="navbar" class="navbar bg-white/95 border-b border-on-surface/10">
        ...
        <nav class="max-w-7xl mx-auto px-4 md:px-16 h-16 flex items-center justify-between">
            ...
            <div class="hidden lg:flex items-center gap-8">
                ...
                <a href="${root}servicios.html" class="font-label-sm text-[13px] uppercase tracking-widest text-on-surface hover:text-on-tertiary-container transition-colors">Casos en Produccion</a>
                <a href="${root}blogprincipal.html" class="font-label-sm text-[13px] uppercase tracking-widest text-on-surface hover:text-on-tertiary-container transition-colors">Centro de Recursos</a>
            </div>
            <div class="flex items-center gap-4">
                <a href="${root}contacto.html" class="hidden md:inline-flex bg-on-tertiary-container text-white px-5 py-2.5 font-label-sm text-[12px] uppercase tracking-widest hover:bg-primary transition-colors">
        ...
        <div id="mobileMenu" class="hidden lg:hidden bg-white border-t border-on-surface/10">
            <div class="px-4 py-6 space-y-4">
                ...
                <a href="${root}contacto.html" class="block bg-on-tertiary-container text-white px-5 py-3 font-label-sm text-[12px] uppercase tracking-widest text-center mt-4">Agendar Auditoria</a>
            </div>
        </div>
    </header>`;
